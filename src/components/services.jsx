...
export default function Services() {
  return (
    <section
      id="projects"
      className="relative z-20 -mt-[100vh] min-h-[240vh] md:min-h-[220vh]"
    >
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="flex flex-col gap-5 md:gap-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-12 gap-4 md:gap-8">
                <span className="md:col-span-2 text-gray-500 uppercase text-sm">
                  (Services)
                </span>
              ...
              {services.map((service, index) => (
                <div
                  ...
                  className={`
                    ...
                    ${
                      index === 0
                        ? "top-[14vh] sm:top-[16vh] md:top-[19vh] mb-[14rem] sm:mb-[16rem] md:mb-[20rem]"
                        : ""
                    }
                    ${
                      index === 1
                        ? "top-[20vh] sm:top-[24vh] md:top-[calc(22vh+6rem)] mb-[10rem] sm:mb-[11rem] md:mb-[13rem]"
                        : ""
                    }
                    ${
                      index === 2
                        ? "top-[26vh] sm:top-[32vh] md:top-[calc(24vh+12rem)] mb-[4rem] sm:mb-[5rem] md:mb-[6rem]"
                        : ""
                    }
                  `}
                >
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-12 gap-3 md:gap-8 items-start py-8 sm:py-6">
                    <span className="md:col-span-2 text-[34px] sm:text-[44px] md:text-[56px] lg:text-[68px] leading-none tracking-tight font-medium text-gray-900">
                      ({service.no})
                    </span>
                  ...
                  {/* content row */}
                  <div className="grid grid-cols-1 md:grid-cols-12 gap-4 md:gap-8 pb-28 sm:pb-40 md:pb-100 min-h-[22vh] md:min-h-[34vh]">
